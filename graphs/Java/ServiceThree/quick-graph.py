...
filenames=["Service3-100.csv", "Service3-1000.csv", "Service3-5000.csv", "Service3-10000.csv", "Service3-50000.csv", "Service3-100000.csv", "Service3-500000.csv", "Service3-1000000.csv", "Service3-1500000.csv"]
...
def plot_bar_all(labels, all_data, all_title):
	...
	for sublist in all_data:
		...
		export_graphs_as_images(fig, "Service3_images", all_title[count])
