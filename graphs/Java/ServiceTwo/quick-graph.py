...
filenames=["Service2-100-5iteration.csv", "Service2-1000-5iteration.csv", "Service2-5000-5iteration.csv", "Service2-10000-5iteration.csv", "Service2-50000-5iteration.csv", "Service2-100000-5iteration.csv", "Service2-500000-5iteration.csv", "Service2-1000000-5iteration.csv", "Service2-1500000-5iteration.csv"]
...
def plot_bar_all(labels, all_data, all_title):
	...
	for sublist in all_data:
		...
		export_graphs_as_images(fig, "Service_images", all_title[count])
