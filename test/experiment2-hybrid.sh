...
# FaaS Programming Languages Comparison Experiment 2: Hybrid
# @author Hanfei Yu
...
do
    ...
    do
        ...
        do
            ...
            # ServiceOne
            ./faas_runner.py -o ./$sub_results_folder/$test_size/$lang/concurrency_$con/iteration_$i --function ServiceOneGo $args --parentPayload $parentPayload1 --payloads $payloads1  

            # ServiceTwo
            ./faas_runner.py -o ./$sub_results_folder/$test_size/$lang/concurrency_$con/iteration_$i --function ServiceTwoJava $args --parentPayload $parentPayload2 --payloads $payloads2   

            # ServiceThree
            ./faas_runner.py -o ./$sub_results_folder/$test_size/$lang/concurrency_$con/iteration_$i --function ServiceThreeGo $args --parentPayload $parentPayload3 --payloads $payloads3
        done
    done
done
