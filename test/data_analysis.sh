    ...
    do
        ...
        do
            ...
            do
                ...
                do
                    result_json=`cat ${PATH_PREFIX}/${data_size}/${lang}/concurrency_${con}/iteration_${i}/${service}${lang}${PATH_SUFFIX}/run${run}.json`
            ...
            runtime_con=$((${runtime_con}/10))
            cpuUsr_con=$((${cpuUsr_con}/10))
            cpuNice_con=$((${cpuNice_con}/10))
            cpuKrn_con=$((${cpuKrn_con}/10))
            cpuIdle_con=$((${cpuIdle_con}/10))
            cpuIowait_con=$((${cpuIowait_con}/10))
            cpuIrq_con=$((${cpuIrq_con}/10))
            cpuSoftIrq_con=$((${cpuSoftIrq_con}/10))
            vmcpusteal_con=$((${vmcpusteal_con}/10))
